 ...
 * @credits    theme_boost - MoodleHQ, Chris Kenniburg
...
// Theme strings.
$string['choosereadme'] = 'The UMB theme is based on the Fordson theme and is adapted for the UMB. Layout is based on the official site of the school.';
$string['configtitle'] = 'Fordson UMB';
$string['pluginname'] = 'Fordson UMB';
...
$string['colours_desc'] = 'Colour choosers will allow you to customize the look and feel of the main elements on the page.';

$string['linkcolor'] = 'Link';
$string['linkcolor_desc'] = 'Choose link color';
$string['navbarbg'] = 'Top menu';
$string['navbarbg_desc'] = 'Background color of top menu.';
$string['bodybgcolor'] = 'Background';
$string['bodybgcolor_desc'] = 'Choose background for site.';
$string['footerlink'] = 'Footer link';
$string['footerlink_desc'] = 'Choose color of link in footer.';
$string['primary'] = 'Button';
$string['primary_desc'] = 'Primar color of button.';
$string['primaryhover'] = 'Hover button';
$string['primaryhover_desc'] = 'Color of hover button.';
$string['fpicon'] = 'Icon Button in Homepage';
$string['fpicon_desc'] = 'Choose color for icon button.';
$string['fpiconhover'] = 'Hover icon Button in Homepage';
$string['fpiconhover_desc'] = 'Choose color for hover icon button.';
$string['headercoursecolor'] = 'Name of course';
$string['headercoursecolor_desc'] = 'Choose color for name.';
$string['blockbg'] = 'Block background';
$string['blockbg_desc'] = 'Choose background color for blocks.';
$string['blockheader'] = 'Block name';
$string['blockheader_desc'] = 'Choose heading color for blocks.';
$string['blockheaderbg'] = 'Background heading color';
$string['blockheaderbg_desc'] = 'Choose for color for blocks.';
$string['breadcrumbcolor'] = 'Breadcrumb';
$string['breadcrumbcolor_desc'] = 'Choose color for background navigation.';
$string['topicheaderbg'] = 'Background topic';
$string['topicheaderbg_desc'] = 'Choose background color for topic.';
$string['topicheader'] = 'Name topic';
$string['topicheader_desc'] = 'Choose background color for topic.';
...
//Info settings.
$string['info_settings'] = 'Link settings';
$string['info1title'] = 'Box 1';
$string['info1title_desc'] = 'Enter name for link.';
$string['info1url'] = 'URL 1';
$string['info1url_desc'] = 'Enter URL address, ex. : http://mail.studenti.umb.sk/.';
$string['info2title'] = 'Box 2';
$string['info2title_desc'] = 'Enter name for link.';
$string['info2url'] = 'URL 2';
$string['info2url_desc'] = 'Enter URL address, ex. : http://mail.studenti.umb.sk/.';
$string['info3title'] = 'Box 3';
$string['info3title_desc'] = 'Enter name for link.';
$string['info3url'] = 'URL 3';
$string['info3url_desc'] = 'Enter URL address, ex. : http://mail.studenti.umb.sk/.';
