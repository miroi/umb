...
$templatecontext = [
    ...
    'enrolform' => $enrolform,
	'info1title' => $PAGE->theme->settings->info1title,
	'info1url' => $PAGE->theme->settings->info1url,
	'info2title' => $PAGE->theme->settings->info2title,
	'info2url' => $PAGE->theme->settings->info2url,
	'info3title' => $PAGE->theme->settings->info3title,
	'info3url' => $PAGE->theme->settings->info3url,
];
